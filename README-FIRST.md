# SIMS Doctor Site Diagnosis v0.6.2
...
配布物の `VERSION`、`README-FIRST.md`、`CHANGELOG.md` もv0.6.2へ更新されています。`appsscript.json` と `SITE-WIDE-RESULT-CONTRACT-V1.md` は内容変更なしです。
